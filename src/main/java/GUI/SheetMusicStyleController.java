...
//		tempoLabel.setText(sliderTempo.getMin()+"");
    ...
    void initialize() {
    	...
    	fontsChoice.setValue(CanvasNotes.font);
    	
		tempBox.setText(JfugueTest.tempo);
		sliderTempo.setValue(Double.parseDouble(JfugueForDrum.tempo));
		
		NoteSpacingBox.setText(CanvasNotes.noteSpacing+"");
		NoteSpacing.setValue(CanvasNotes.noteSpacing);
		
		
		LineSpacingBox.setText(CanvasNotes.lineSpacing+"");
		LineSpacing.setValue(CanvasNotes.noteSpacing);
    }
